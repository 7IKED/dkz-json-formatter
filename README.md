...
![Lines](https://img.shields.io/badge/Lines-685-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-json-formatter.git

# Oeffnen
cd dkz-json-formatter
